...
namespace ICSharpCode.AvalonEdit.CodeCompletion
{
    ...
    /// 自动完成类实例
    /// </summary>
    public static class AutoCompletions
    {
        private static readonly CSharpCompletion sharpCompletion = new CSharpCompletion();

        /// <summary>
        /// C#语言自动完成类
        /// </summary>
        public static CSharpCompletion CSharp { get { return sharpCompletion; } }
    }
...
//					typeof(ICSharpCode.NRefactory.TypeSystem.IProjectContent).Assembly,
        ...
        {
            var loader = new CecilLoader();
            loader.DocumentationProvider = GetXmlDocumentation(assembly.Location);
            var unresolvedAssembly = loader.LoadAssemblyFile(assembly.Location);
