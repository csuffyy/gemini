...
namespace ICSharpCode.AvalonEdit.CodeCompletion.DataItems
{
    class CompletionData : NRefactory.Completion.ICompletionData, AvalonEdit.CodeCompletion.ICompletionData
    {
        ...
        readonly List<NRefactory.Completion.ICompletionData> overloadedData = new List<NRefactory.Completion.ICompletionData>();
        public IEnumerable<NRefactory.Completion.ICompletionData> OverloadedData
        {
            get { return overloadedData; }
        }

        public void AddOverload(NRefactory.Completion.ICompletionData data)
        {
